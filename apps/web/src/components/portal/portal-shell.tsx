...
export function PortalShell({
  ...
  return (
    <div className="flex min-h-[100dvh] w-full flex-col bg-[var(--surface-page)]">
      <header className="flex h-14 shrink-0 items-center justify-between gap-3 bg-[var(--surface-brand)] px-4 lg:px-6">
      ...
      <main
        className={cn(
          "mx-auto flex min-h-0 w-full max-w-[var(--page-max)] flex-1 flex-col px-4 pb-20 lg:px-6 lg:pb-8",
          mainClassName,
        )}
      >
        {children}
